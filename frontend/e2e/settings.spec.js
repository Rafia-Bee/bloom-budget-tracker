...
test.describe("Settings Page", () => {
  ...
  test.describe("Subcategories Tab", () => {
    ...
    test("can open Create Subcategory modal", async ({ page }) => {
      ...
      await expect(
        page
          .locator("text=/Create Subcategory|Add Subcategory|New Subcategory/i")
          .first(),
  ...
  test.describe("Feature Flags", () => {
    test("feature flags section visible in preferences", async ({ page }) => {
      // Switch to Preferences tab
      await page.locator("button:has-text('Preferences')").click();
      await page.waitForTimeout(500);
      ...
      const isVisible = await featureFlags.first().isVisible({ timeout: 2000 });
