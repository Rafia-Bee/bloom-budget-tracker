    ...
    <div className="fixed inset-0 bg-black/50 dark:bg-black/70 flex items-center justify-center z-50">
      <div className="bg-white dark:bg-dark-surface rounded-2xl shadow-xl w-full max-w-md mx-4 p-6">
        <div className="flex justify-between items-center mb-6">
          <div>
            <h2 className="text-2xl font-bold text-bloom-pink dark:text-dark-pink">Debt Payment</h2>
            <p className="text-sm text-gray-500 dark:text-dark-text-secondary mt-1">Record a payment toward your debt</p>
          </div>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label className="block text-gray-700 dark:text-dark-text font-semibold mb-2">Select Debt</label>
            <select
              value={selectedDebt}
          ...
          <div>
            <label className="block text-gray-700 dark:text-dark-text font-semibold mb-2">Payment Date</label>
            <input
              type="date"
              value={date}
