                ...
                >
                    ...
                    <div>
                        ...
                        <div className="flex gap-2 w-full">
                            ...
                            <input
                                ...
                                placeholder={`0.00`}
                                className="flex-1 min-w-0 px-3 sm:px-4 py-2 border border-gray-300 dark:border-dark-border rounded-lg bg-white dark:bg-dark-elevated text-gray-900 dark:text-dark-text focus:outline-none focus:ring-2 focus:ring-bloom-pink dark:focus:ring-dark-pink"
                                required
                            />
                        </div>
                    </div>
                                ...
                                if (newSubcats.length > 0) {
                                    ...
                                    if (newCategory === 'Debt Payments') {
                                        if (firstSubcat === 'Credit Card') {
                                            ...
                                            const selectedDebt = debts.find(
                                                (d) => d.name === firstSubcat
                                            );
                                            if (selectedDebt && selectedDebt.monthly_payment) {
                                                setAmount(
                                                    (selectedDebt.monthly_payment / 100).toFixed(2)
                                                );
                                            }
                                    ...
                                    if (newCategory === 'Savings & Investments') {
                                        const selectedGoal = goals.find(
                                            (g) => g.subcategory_name === firstSubcat
                                        );
                                        if (selectedGoal) {
                                            setName(`${selectedGoal.name} Contribution`);
                                        } else {
                    ...
                    {isRecurring && (
                        <div className="bg-purple-50 dark:bg-dark-elevated border border-purple-200 dark:border-dark-border rounded-lg p-4 space-y-3">
                            <h3 className="font-semibold text-purple-900 dark:text-dark-pink mb-2">
                                Recurrence Schedule
                            </h3>
