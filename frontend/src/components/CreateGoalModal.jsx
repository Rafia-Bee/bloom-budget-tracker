                            ...
                            <div className="flex items-start space-x-2">
                                ...
                                <div>
                                    <p className="text-blue-700 dark:text-blue-300 text-sm">
                                        <strong>How it works:</strong> Creating this goal will
                                        automatically create a subcategory under "Savings &
                                        Investments". Add expenses to that subcategory to track your
                                        progress!
                                    </p>
                                </div>
                            </div>
