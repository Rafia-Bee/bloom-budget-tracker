/**
 * Bloom - Create Subcategory Modal
 *
 * Modal for creating new custom subcategories.
 */

import { useState } from 'react'
import PropTypes from 'prop-types'

function CreateSubcategoryModal({ onClose, onCreate, initialCategory }) {
  const [name, setName] = useState('')
  const [category, setCategory] = useState(initialCategory || 'Fixed Expenses')
