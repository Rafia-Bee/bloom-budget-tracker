                ...
                <div className="p-6">
                    ...
                    <div className="bg-gray-50 dark:bg-dark-elevated rounded-lg p-4 mb-6">
                        ...
                        <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                            <div
                                ...
                                style={{
                                    width: `${Math.min(100, goal.progress?.percentage || 0)}%`,
                                }}
                            ></div>
                        </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        {goal.progress?.current_amount > 0 &&
                            parseFloat(formData.target_amount) * 100 <
                                goal.progress.current_amount && (
                                    ...
                                    <div className="flex items-start space-x-2">
                                        ...
                                        <div>
                                            <p className="text-orange-700 dark:text-orange-300 text-sm">
                                                <strong>Warning:</strong> Setting the target below
                                                your current savings (
                                                {formatCurrency(goal.progress.current_amount)}) will
