    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="sticky top-0 bg-white border-b border-gray-200 px-6 py-4 flex items-center justify-between rounded-t-2xl">
          <div>
            <h2 className="text-2xl font-bold text-gray-900">⚗️ Experimental Features</h2>
            <p className="text-sm text-gray-500 mt-1">Enable features in development</p>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-6 space-y-4">
          ...
          {flags.experimentalFeaturesEnabled && (
            <div className="border border-dashed border-gray-300 rounded-lg p-4 text-center text-gray-500">
              ...
              <p className="text-xs mt-1">New features will appear here as they're developed</p>
            </div>
          )}
        </div>
