      ...
      <div className="bg-white dark:bg-dark-surface rounded-2xl shadow-lg p-6 border-2 border-bloom-mint dark:border-bloom-mint/50">
        <div className="flex justify-between items-start mb-4">
          <div className="flex-1">
            ...
            <p className="text-2xl font-semibold text-bloom-mint dark:text-dark-success mt-2">
              {fcEur(debitAvailable * 100)} <span className="text-sm text-gray-500 dark:text-dark-text-tertiary font-normal">available</span>
            </p>
          </div>
        ...
        <div className="mt-4">
          ...
          <div className="flex justify-between text-xs text-gray-500 dark:text-gray-400 mt-1">
            ...
            <span>{totalIncome > 0 ? ((debitAvailable / totalIncome) * 100).toFixed(0) : 0}% of total</span>
          </div>
        </div>
      </div>
        ...
        <div className="bg-white dark:bg-dark-surface rounded-2xl shadow-lg p-6 border-2 border-bloom-pink dark:border-bloom-pink/50">
          <div className="flex justify-between items-start mb-4">
            <div className="flex-1">
              ...
              <p className="text-2xl font-semibold text-bloom-mint dark:text-dark-success mt-2">
                {fcEur(creditAvailable * 100)} <span className="text-sm text-gray-500 dark:text-gray-400 font-normal">available</span>
              </p>
            </div>
