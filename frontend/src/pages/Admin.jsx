...
function Admin() {
    ...
    const handleRemoveDuplicates = async () => {
        if (
            !confirm(
                'Remove duplicate Initial Balance entries? This will keep only the earliest one for each user.'
            )
        ) {
            return;
        }
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="border dark:border-gray-700 rounded-lg p-6">
                            ...
                            <p className="text-gray-600 dark:text-gray-400 mb-4">
                                Removes duplicate "Initial Balance" income entries, keeping only the
                                earliest one for each user. This is a one-time cleanup for a bug
                                that was fixed in commit 76fb0c0.
                            </p>
                            <button
                                                ...
                                                {result.details.map((detail, idx) => (
                                                    ...
                                                    >
                                                        ...
                                                        <div className="text-green-700 dark:text-green-300">
                                                            ✓ Kept: €
                                                            {(detail.kept.amount / 100).toFixed(2)}{' '}
                                                            ({detail.kept.date})
                                                        </div>
