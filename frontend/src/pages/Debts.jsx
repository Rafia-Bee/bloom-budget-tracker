...
function Debts({ setIsAuthenticated }) {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-bloom-light to-white dark:from-dark-base dark:to-dark-surface">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                    <div className="bg-white dark:bg-dark-surface rounded-2xl shadow-lg p-6">
                        ...
                        <div className="mt-4 text-sm text-gray-500 dark:text-dark-text-tertiary">
                            Across {getAllDebts().length}{' '}
                            {getAllDebts().length === 1 ? 'debt' : 'debts'}
                        </div>
                    </div>
                    ...
                    {getAllDebts().length === 0 ? (
                        <div className="text-center py-12">
                            ...
                            <p className="text-gray-600 dark:text-dark-text-secondary mb-4">
                                Add your debts to track payoff progress
                            </p>
                            <button
                                onClick={() => setShowAddModal(true)}
                        ...
                        <div className="space-y-4">
                            {getAllDebts().map((debt) => {
                                ...
                                return (
                                    <div
                                        key={debt.id}
                                        className={`border rounded-lg p-3 sm:p-6 hover:shadow-md transition ${debt.isVirtual ? 'border-blue-300 bg-blue-50 dark:border-blue-600 dark:bg-blue-950/30' : 'border-gray-200 dark:border-dark-border dark:bg-dark-elevated'}`}
                                    >
                                        ...
                                        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-3 sm:gap-4">
                                            <div className="flex-1 min-w-0">
                                                ...
                                                <div className="flex items-start gap-2 mb-2 sm:mb-3">
                                                    <h3 className="text-base sm:text-xl font-bold text-gray-800 dark:text-dark-text break-words flex-1">
                                                        {debt.name}
                                                    </h3>
                                                    {debt.isVirtual && (
                                                        <span className="text-xs bg-blue-200 text-blue-800 px-2 py-0.5 sm:py-1 rounded-full whitespace-nowrap flex-shrink-0">
                                                            Auto-calculated
                                                        </span>
                                                    )}
                                                </div>
                                                ...
                                                <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-3 text-sm">
                                                    <div>
                                                        <p className="text-gray-500 dark:text-dark-text-tertiary text-xs mb-0.5">
                                                            Debt
                                                        </p>
                                                    ...
                                                    <div>
                                                        ...
                                                        {monthly > 0 ? (
                                                            ...
                                                            <>
                                                                <p className="font-semibold text-green-600 dark:text-dark-success text-sm sm:text-base">
                                                                    {fcEur(0)}
                                                                </p>
                                                                {debt.isVirtual && (
                                                                    <p className="text-xs text-gray-500 dark:text-dark-text-tertiary">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p className="font-semibold text-gray-800 dark:text-dark-text text-sm sm:text-base">
                                                            {monthsLeft
                                                                ? `${monthsLeft} ${monthsLeft === 1 ? 'mo' : 'mos'}`
                                                                : 'Set payment'}
                                                        </p>
                                                    </div>
                                                </div>
                                        ...
                                        <div className="mt-4 pt-4 border-t border-gray-200 dark:border-dark-border">
                                            <button
                                                onClick={() =>
                                                    toggleDebtExpansion(debt.id, debt.name)
                                                }
                                            ...
                                            >
                                                ...
                                                {expandedDebtId === debt.id ? 'Hide' : 'View'}{' '}
                                                Payment History
                                            </button>
                                        </div>
                                        ...
                                        {expandedDebtId === debt.id && (
                                            <div className="mt-4 pt-4 border-t border-gray-200 dark:border-dark-border">
                                                ...
                                                {debtTransactions[debt.id] &&
                                                debtTransactions[debt.id].length > 0 ? (
                                                    <div className="space-y-2 max-h-96 overflow-y-auto">
                                                        {debtTransactions[debt.id].map(
                                                            (transaction) => {
                                                                const txAmount =
                                                                ...
                                                                return (
                                                                    <div
                                                                        key={transaction.id}
                                                                        className="flex justify-between items-center p-3 bg-gray-50 dark:bg-dark-elevated rounded-lg"
                                                                    >
                                                                        ...
                                                                        <div className="text-right">
                                                                            <p className="font-semibold text-green-600 dark:text-dark-success">
                                                                                {txAmount.display}
                                                                            </p>
                                                                            {txAmount.showDual && (
                                                    ...
                                                    <p className="text-gray-500 dark:text-dark-text-tertiary text-center py-4">
                    ...
                    {showArchived &&
                        (archivedDebts.length === 0 ? (
                            <div className="text-center py-8 text-gray-500 dark:text-dark-text-tertiary">
                                <svg
                                    className="w-12 h-12 mx-auto mb-2 text-gray-300 dark:text-dark-muted"
                                    fill="none"
                                    stroke="currentColor"
                                    viewBox="0 0 24 24"
                                >
                                ...
                                <p className="text-sm mt-1">
                                    Debts are automatically archived when fully paid
                                </p>
                            </div>
                        ) : (
                            <div className="space-y-3">
                                {archivedDebts.map((debt) => {
                                    ...
                                    return (
                                        <div
                                            key={debt.id}
                                            className="border border-green-300 dark:border-green-700 bg-green-50 dark:bg-green-950/20 rounded-lg p-4"
                                        >
                                            ...
                                            {isExpanded && (
                                                <div className="mt-4 pt-4 border-t border-green-300 dark:border-green-700">
                                                    <h4 className="font-semibold text-gray-700 dark:text-dark-text mb-2">
                                                        Payment History
                                                    </h4>
                                                    {transactions.length === 0 ? (
                                                        ...
                                                        <div className="space-y-2">
                                                            {transactions.map((transaction) => (
                                                                <div
                                                                    key={transaction.id}
                                                                    className="flex justify-between items-center text-sm bg-white dark:bg-dark-elevated p-2 rounded border border-green-200 dark:border-green-700"
                                                                >
                                                                    <div>
                                                                    ...
                                                                    <p className="font-semibold text-green-700 dark:text-dark-success">
                                                                        {fcEur(transaction.amount)}
                                                                    </p>
                                                                </div>
                                                            ))}
                                                        </div>
            ...
            {/* Add Debt Modal */}
            {showAddModal && (
                <AddDebtModal onClose={() => setShowAddModal(false)} onAdd={handleAddDebt} />
            )}
