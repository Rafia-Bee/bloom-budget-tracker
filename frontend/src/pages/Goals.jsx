                            ...
                            <div className="flex items-start space-x-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-blue-700 dark:text-blue-300 text-sm">
                                        Create a goal with a target amount and deadline. When you
                                        add expenses in "Savings & Investments" → your goal's
                                        subcategory, they automatically count toward your progress.
                    ...
                    <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start">
                        {goals.length === 0 ? (
                            ...
                            goals.map((goal) => (
                                <div
                                    key={goal.id}
                                    className="bg-white dark:bg-dark-elevated rounded-xl shadow-sm border border-gray-200 dark:border-dark-border overflow-hidden hover:shadow-md transition-shadow"
                                >
                                    {/* Goal Header */}
                                    <div className="p-6 pb-4">
                                        ...
                                        <div className="mb-4">
                                            <div className="flex justify-between text-sm text-gray-600 dark:text-gray-300 mb-2">
                                                <span>
                                                    {fcEur(goal.progress.current_amount)} saved
                                                </span>
                                    ...
                                    <div className="px-6 py-3 border-t border-gray-200 dark:border-dark-border">
                                        ...
                                        >
                                            ...
                                            {expandedGoalIds.has(goal.id) ? 'Hide' : 'View'}{' '}
                                        ...
                                        <div className="px-6 pb-6 border-t border-gray-200 dark:border-dark-border">
                                            {loadingGoalIds.has(goal.id) ? (
                                                ...
                                                <div className="pt-4">
                                                    ...
                                                    {goalTransactions[goal.id].transactions
                                                        ?.length > 0 ? (
                                                        <div className="space-y-2 max-h-64 overflow-y-auto">
                                                            {goalTransactions[
                                                                ...
                                                                return (
                                                                    <div
                                                                        key={transaction.id}
                                                                        className="flex justify-between items-center p-3 bg-gray-50 dark:bg-dark-surface rounded-lg"
                                                                    >
                                                        ...
                                                        <p className="text-gray-500 dark:text-gray-400 text-center py-6 text-sm">
                                                            No contributions yet. Add expenses to
                                                            "Savings & Investments" → "
                                                            {goal.subcategory_name}" to track
                                                            progress!
                                                        </p>
                                                    )}
                                                </div>
                                    ...
                                    <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-3 mb-4">
                                        ...
                                        {deleteConfirm.contribution_count && (
                                            <p className="text-red-600 dark:text-red-300 text-xs mt-2">
                                                Force Delete will move{' '}
                                                {deleteConfirm.contribution_count} contribution(s)
                                                to "Other" subcategory.
                                            </p>
                                        )}
                                    </div>
                                ) : (
