...
describe('BankImportModal', () => {
  ...
  describe('Rendering - Input Step', () => {
    it('renders the modal with title', () => {
      ...
      expect(screen.getByRole('heading', { name: 'Import Bank Transactions' })).toBeInTheDocument()
    })
    ...
    it('renders textarea for transaction data', () => {
      ...
      expect(screen.getByPlaceholderText(/Paste your bank transactions here/)).toBeInTheDocument()
    })
