...
describe('EditIncomeModal', () => {
    ...
    describe('Rendering', () => {
        it('renders the modal with title', () => {
            render(
                <EditIncomeModal onClose={mockOnClose} onEdit={mockOnEdit} income={mockIncome} />
            );
    ...
    describe('Pre-filled Data', () => {
        ...
        it('handles different date formats correctly', () => {
            ...
            render(
                <EditIncomeModal onClose={mockOnClose} onEdit={mockOnEdit} income={altIncome} />
            );
        ...
        it('handles invalid date format gracefully', () => {
            ...
            render(
                <EditIncomeModal onClose={mockOnClose} onEdit={mockOnEdit} income={invalidIncome} />
            );
