...
describe('LeftoverBudgetModal', () => {
  ...
  const mockLeftoverData = {
    ...
    allocation_options: {
      ...
      goals: [
        { id: 1, name: 'Emergency Fund', target_amount: 100000, progress: 25000, subcategory_name: 'Emergency Fund' },
        { id: 2, name: 'Vacation', target_amount: 200000, progress: 50000, subcategory_name: 'Vacation Fund' }
      ]
    }
  }
  ...
  describe('No Leftover State', () => {
    it('shows week complete message when leftover is zero', async () => {
      ...
      expect(screen.getByText("You've used your entire weekly budget. Great job staying on track!")).toBeInTheDocument()
    })
  ...
  describe('Debt Selection', () => {
    ...
    it('shows no debts message when empty', async () => {
      api.get.mockResolvedValue({
        data: {
          ...mockLeftoverData,
          allocation_options: { debts: [], goals: mockLeftoverData.allocation_options.goals }
        }
      })
  ...
  describe('Goal Selection', () => {
    ...
    it('shows no goals message when empty', async () => {
      ...
      api.get.mockResolvedValue({
        data: {
          ...mockLeftoverData,
          allocation_options: { debts: mockLeftoverData.allocation_options.debts, goals: [] }
        }
      })
