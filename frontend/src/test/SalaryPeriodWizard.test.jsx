...
describe('SalaryPeriodWizard', () => {
  ...
  const mockPreviewResponse = {
    ...
    end_date: '2026-01-20',
    weeks: [
      { week_number: 1, start_date: '2025-12-24', end_date: '2025-12-30', budget_amount: 37500 },
      { week_number: 2, start_date: '2025-12-31', end_date: '2026-01-06', budget_amount: 37500 },
      { week_number: 3, start_date: '2026-01-07', end_date: '2026-01-13', budget_amount: 37500 },
      { week_number: 4, start_date: '2026-01-14', end_date: '2026-01-20', budget_amount: 37500 }
    ]
  }
  ...
  describe('Form Submission', () => {
    ...
    it('calls API to create new salary period', async () => {
      ...
      await waitFor(() => {
        ...
        expect(api.post).toHaveBeenCalledWith('/salary-periods', expect.objectContaining({
  ...
  describe('Currency Parsing', () => {
    it('handles various currency input formats', async () => {
      ...
      await waitFor(() => {
        ...
        expect(api.post).toHaveBeenCalledWith('/salary-periods/preview', expect.objectContaining({
