...
try:
    ...
    if len(initial_balances) > 1:
        ...
        delete_ids = [inc_id for inc_id, _, _ in initial_balances if inc_id != keep_id]
        ...
        print(f"  ✓ Deleted {len(delete_ids)} duplicate Initial Balance entries")
    ...
    if duplicates_to_delete:
        ...
        print(f"  ✓ Deleted {len(duplicates_to_delete)} duplicate Other entries")
